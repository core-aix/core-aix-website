...
Work at CORE-AIx is organised around a small set of connected research themes.

![Research topics overview](/images/research/research_areas.png)

## 1) Reliable agentic AI

Reliable agentic AI is a core focus, aimed at systems that remain dependable in practical, high-stakes settings. The emphasis is on long-horizon robustness, constraint-aware planning and execution, and evaluation methods that go beyond single-turn accuracy to assess stability, recoverability, and consistency across full workflows. Work in this area also connects agent design with optimisation and distributed-systems principles so that performance and controllability scale together in real deployments.
...
Rather than treating deployment as a fixed engineering choice, this direction frames inference as an online optimisation problem where decisions adapt to workload characteristics and service goals.
...
## 3) Optimisation and data quality for foundation-model learning

Another line of work examines how optimisation theory and data curation influence the quality and efficiency of modern model training and adaptation.
